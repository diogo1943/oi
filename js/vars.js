var projs_new = [
    ...
    {
        index: 0,
        title_home: 'Just The Wind (2019)',
        title_full: 'Just The Wind (2019)',
    ...
    {
        index: 1,
        title_home: '420@ôa (2019)',
        title_full: '420@ôa (2019)',
        date: 'October 12, 2019 11:13:00',
        service: 'Art Direction',
        text: 'Cover art design for DJ 420@ôa’s 2019 album debut.',
        collaboration: '',
    ...
    {
        index: 2,
        title_home: "As Foretold (2019)",
        title_full: "As Foretold (2019)",
        date: 'October 12, 2019 11:13:00',
        service: 'Editorial Design / Web Development / Webdesign',
        ...
        thumbnail: 'foretold.jpg',
        images: ['foretold.jpg']
    },
    {
        index: 3,
        title_home: "It Takes Several Minutes... (2019)",
    ...
    {
        index: 4,
        title_home: 'Evolutionary Leap® (2020)',
        title_full: 'Evolutionary Leap® (2020)',
        date: 'October 12, 2019 11:13:00',
        service: 'Editorial Design / Web Development / Webdesign',
        text: '<i>Evolutionary Leap®</i> is a project created with the intent of exploring what it means to be transhuman, what is transhumanism compared with other philosophical ideologies from the same spectrum and to reflect on how transhuman are we already. The goal was to compile a group of “objects”, being them mostly essays, articles, images or projects, that would reflect upon these questions.<br><br>The project is composed by two artifacts: the book and this website. The book is the main archive, containing the majority of the contents, while the website provides a bridge to the transhumanist culture by providing a lexicon explaining common terms associated with the subjects.<br><br><a class="proj_links" target="blank" href="http://2020.fbaul-dcnm.pt/evolutionary_leap/">Project Website →</a>',
        collaboration: '',
    ...
    {
        index: 5,
        title_home: 'Cinenova (2020)',
        title_full: 'Cinenova (2020)',
        date: 'October 12, 2019 11:13:00',
        service: 'Art Direction / Brand Identity / Web Development / Webdesign',
        text: 'Organized by university students and professors of NOVA-FCSH, CINENOVA is the first Interuniversity Film Festival in Portugal. Its goal is to focus on the relationship between Cinema and Knowledge, and to bolster student directors and their projects.<br><br>This project comes as a collaboration with the Fine-Arts School of Lisbon (FBAUL) where a small team was assembled to develop the new brand identity, communication and website for the festival.<br><br><a class="proj_links" target="blank" href="https://cinenova.fcsh.unl.pt/">Project Website →</a>',
        collaboration: 'colab w/:<br>Tiago Nunes<br><br>',
        thumbnail: 'cinenova/cinenova.png',
        images: ['cinenova/cine_logo.svg', 'cinenova/cinenova.png', 'cinenova/poster-01.png', 'cinenova/cine_site-01.png', 'cinenova/cine_site-02.png', 'cinenova/cine_site-03.png', 'cinenova/cine_site-04.png', ]
    },
    {
        index: 6,
        ...
        date: 'October 12, 2019 11:13:00',
        service: 'Art Direction / Brand Identity / Webdesign',
        text: '<i>Evolutionary Leap®</i> is a project created with the intent of exploring what it means to be transhuman, what is transhumanism compared with other philosophical ideologies from the same spectrum and to reflect on how transhuman are we already. The goal was to compile a group of “objects”, being them mostly essays, articles, images or projects, that would reflect upon these questions.<br><br>The project is composed by two artifacts: the book and this website. The book is the main archive, containing the majority of the contents, while the website provides a bridge to the transhumanist culture by providing a lexicon explaining common terms associated with the subjects.<br><br><a class="proj_links" target="blank" href="http://2020.fbaul-dcnm.pt/evolutionary_leap/">Project Website →</a>',
    ...
    {
        index: 7,
        title_home: 'Proxy, The World (2020)',
        title_full: 'Proxy, The World (2020)',
        date: 'May 21, 2020 11:13:00',
        service: 'Art Direction',
        ...
        date: 'June 01, 2020 11:13:00',
        service: 'Art Direction / Webdesign / Web Development',
        text: "Design Project for DJ 420@ôa’s 2020 album release. Using the cover art as the center piece and playing around with the layering motif resulted on a website, communication and images for the music videos.<br><br><a class='proj_links' target='blank' href='http://ittakesseveralminutes.belasartes.ulisboa.pt/'>Project Website →</a>",
        collaboration: '',
        thumbnail: 'fantasia/fantasia.png',
        images: ['fantasia/fantasia_flat.png', 'fantasia/borderless.png', 'fantasia/fantasia-logo_1.png', 'fantasia/vynil.png']
    },
    {
        index: 9,
        title_home: 'Living On The Edge Of (2020)',
